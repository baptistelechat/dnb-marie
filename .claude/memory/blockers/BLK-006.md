...
# BLK-006 — ESLint `react-hooks/set-state-in-effect` (3ème occurrence) — setState fin de partie dans useEffect
...
- [BLK-003](../blockers/BLK-003.md) — 1ère et 2ème occurrences du même pattern ESLint
