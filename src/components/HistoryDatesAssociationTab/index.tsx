...
import { useHistoryDatesAssociationLeaderboard } from "./hooks/useHistoryDatesAssociationLeaderboard";
...
const HistoryDatesAssociationTab = () => {
  const { tick, success, error: hapticError } = useHaptics();
  const { getEntries, addEntry } = useHistoryDatesAssociationLeaderboard();
    ...
    <div className="flex flex-col gap-4 py-4 px-4 max-w-2xl mx-auto">
      <div className="text-center pt-3 pb-1">
        ...
        <p className="text-slate-400 text-sm font-semibold">
          Relie chaque événement à sa date 📅
        </p>
      </div>
...
export default HistoryDatesAssociationTab;
