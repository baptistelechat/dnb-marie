...
import { useHistoryPersonnagesAssociationLeaderboard } from "./hooks/useHistoryPersonnagesAssociationLeaderboard";
...
const HistoryPersonnagesAssociationTab = () => {
  const { tick, success, error: hapticError } = useHaptics();
  const { getEntries, addEntry } =
    useHistoryPersonnagesAssociationLeaderboard();
    ...
    <div className="flex flex-col gap-4 py-4 px-4 max-w-2xl mx-auto">
      <div className="text-center pt-3 pb-1">
        ...
        <p className="text-slate-400 text-sm font-semibold">
          Relie chaque personnage à son mot-clé 🧑‍🎓
        </p>
      </div>
      ...
      {timerStartedAt === null ? (
        <div className="flex flex-col items-center justify-center gap-3 p-6 rounded-3xl border-2 border-purple-200 bg-purple-50">
          ...
          >
            🧑‍🎓 {TOTAL} paires personnage ↔ mot-clé
          </p>
          <button
            type="button"
            onClick={handleGo}
        ...
        <AssociationBoard
          ...
          leftLabel="Personnages"
          rightLabel="Mots-clés"
        />
      )}
...
export default HistoryPersonnagesAssociationTab;
