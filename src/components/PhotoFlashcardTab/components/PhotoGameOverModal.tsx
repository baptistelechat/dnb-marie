...
interface PhotoGameOverModalProps {
  firstTryScore: number;
  hintScore?: number;
  totalItems: number;
  totalTimeSeconds: number;
  leaderboard: PhotoLeaderboardEntry[];
...
const PhotoGameOverModal = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="photo-gameover-title"
    >
      <div
...
export default PhotoGameOverModal;
