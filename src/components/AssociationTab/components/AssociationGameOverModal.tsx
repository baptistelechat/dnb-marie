...
const AssociationGameOverModal = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="association-gameover-title"
    >
      <div
      ...
      >
        ...
        {!saved && (
          <div className="flex flex-col gap-2">
            <label
              htmlFor="association-player-name"
...
export default AssociationGameOverModal;
