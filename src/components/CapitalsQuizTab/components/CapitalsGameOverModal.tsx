...
import type { CapitalsLeaderboardEntry, CapitalsDirection } from "../types";
...
const DIRECTION_LABELS: Record<CapitalsDirection, string> = {
  "country-to-capital": "Pays → Capitale",
  "capital-to-country": "Capitale → Pays",
};

const DIRECTION_ICONS: Record<CapitalsDirection, string> = {
  "country-to-capital": "🌍",
  "capital-to-country": "🏛️",
};
...
const CapitalsGameOverModal = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="capitals-gameover-title"
    >
      <div
...
export default CapitalsGameOverModal;
