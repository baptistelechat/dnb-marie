...
interface QSJGameOverModalProps {
  firstTryScore: number;
  hintScore: number;
  totalItems: number;
  totalTimeSeconds: number;
  leaderboard: QSJLeaderboardEntry[];
...
const QSJGameOverModal = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="qsj-gameover-title"
    >
      <div
...
export default QSJGameOverModal;
