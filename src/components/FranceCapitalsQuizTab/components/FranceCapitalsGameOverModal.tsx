...
interface FranceCapitalsGameOverModalProps {
  firstTryScore: number;
  total: number;
  totalTimeSeconds: number;
  leaderboard: FranceCapitalsLeaderboardEntry[];
...
const DIRECTION_LABELS: Record<FranceCapitalsDirection, string> = {
  "region-to-capital": "Région → Chef-lieu",
  "capital-to-region": "Chef-lieu → Région",
};

const FranceCapitalsGameOverModal = ({
  firstTryScore,
  total,
  totalTimeSeconds,
  leaderboard,
  ...
  onSave,
  onReplay,
}: FranceCapitalsGameOverModalProps) => {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="france-caps-gameover-title"
    >
      <div
      ...
      >
        ...
        {!saved && (
          <div className="flex flex-col gap-2">
            <label
              htmlFor="france-caps-player-name"
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: "#7e57c2" }}
                    >
                      {entry.firstTryScore}/{entry.totalRegions}
                    </span>
                    <span
...
export default FranceCapitalsGameOverModal;
