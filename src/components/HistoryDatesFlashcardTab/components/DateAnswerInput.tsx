...
interface DateAnswerInputProps {
  direction: HistoryDatesFlashcardDirection;
  lastResult: HistoryDatesLastResult;
...
const DateAnswerInput = ({
  ...
  const hintAnswer = correctAnswer;
...
export default DateAnswerInput;
