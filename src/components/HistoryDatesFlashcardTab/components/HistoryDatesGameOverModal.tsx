...
interface HistoryDatesGameOverModalProps {
  firstTryScore: number;
  hintScore?: number;
  totalItems: number;
  totalTimeSeconds: number;
  leaderboard: HistoryDatesLeaderboardEntry[];
...
const DIRECTION_LABELS: Record<HistoryDatesFlashcardDirection, string> = {
  "date-to-event": "Date → Événement",
  "event-to-date": "Événement → Date",
};

const DIRECTION_ICONS: Record<HistoryDatesFlashcardDirection, string> = {
  "date-to-event": "📅",
  "event-to-date": "📖",
};
...
const HistoryDatesGameOverModal = ({
  firstTryScore,
  hintScore = 0,
  totalItems,
  totalTimeSeconds,
  ...
  onSave,
  onReplay,
}: HistoryDatesGameOverModalProps) => {
  const missedScore = totalItems - firstTryScore - hintScore;
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="history-dates-gameover-title"
    >
      <div
      ...
      >
        <div className="text-center flex flex-col gap-2">
          ...
          <h2
            id="history-dates-gameover-title"
        ...
        {!saved && (
          <div className="flex flex-col gap-2">
            <label
              htmlFor="history-dates-player-name"
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      ...
                      style={{ color: "#9575cd" }}
                      aria-label={`Direction : ${DIRECTION_LABELS[entry.direction]}`}
                    >
...
export default HistoryDatesGameOverModal;
